CREATE OR REPLACE TABLE `sofia-data-305018.mlr_optimization.base_payments_provider_socios_embeddings` AS 
...
-- Detect outliers con autoenconder y matrix factorization para detectar comportamientos extraños (investigar como usar matrix factorizacion para detectar outliers o fallas o ...)
-- dividir los costos por cpt, buscar un diccionario de costos e igual para icd
