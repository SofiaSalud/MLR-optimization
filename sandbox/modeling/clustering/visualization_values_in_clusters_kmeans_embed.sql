...
FROM
  ML.PREDICT(MODEL `sofia-data-305018.mlr_optimization.kmeans_clustering_embed`, --Este es el modelo, un modelo de clustering ideal y representativo es aquel q tiene mas valores unicos por cada feature y tiene menos cruce de valores unicos con otros clusters. 
    (
    SELECT 
      *
FROM(
